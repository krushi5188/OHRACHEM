...
"""
    ...
    # Let's insert it before the FAQ section
    if '<h2>Frequently Asked Questions</h2>' in c:
        c = c.replace('<h2>Frequently Asked Questions</h2>', f'{expansion}\n<h2>Frequently Asked Questions</h2>')
    elif '<h2>Frequently Asked Questions (FAQs)</h2>' in c:
        c = c.replace('<h2>Frequently Asked Questions (FAQs)</h2>', f'{expansion}\n<h2>Frequently Asked Questions (FAQs)</h2>')
